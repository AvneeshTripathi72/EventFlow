    ...
    <main className="about-page-layout">
      ...
      <div className="lux-container">
        ...
        <section className="about-intro-section">
          ...
          <p>
            From our platform, you can quickly hire the best singers for your event, whether you want a solo singer or a more energetic group performance. We have several options, including the option to book a live band that is suitable for the atmosphere of your event.
          </p>
          <p>
          ...
          <p className="intro-footer-text">
            Transform your event into an unforgettable musical journey—where quality meets convenience for every occasion.
          </p>
        </section>
