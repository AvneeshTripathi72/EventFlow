    ...
    <footer className="lux-footer">
      ...
      <div ref={revealRef} className="lux-footer-inner">
        ...
        <section className="lux-footer-newsletter reveal-child">
          <div className="lux-footer-newsletter-text">
        ...
        <section className="lux-footer-grid reveal-child">
          <div className="lux-footer-brand-col">
            ...
            <div className="lux-footer-social-row">
              <SocialLink
                href="https://www.instagram.com/magnevents.in?utm_source=qr&igsh=Y29qa2cxY25rNmtk"
                label="Instagram"
                platform="instagram"
              ...
              />
              <SocialLink
                href="https://youtube.com/@magnevents?si=fIU-2dKaLsG1DAJu"
                label="YouTube"
                platform="youtube"
